---
description: Steg-för-steg-guiden för att installera och konfigurera Marketo Measure-paketet i Microsoft Dynamics CRM
...
1. Välj [!UICONTROL Credentials] eller [!UICONTROL OAuth].
   ...
   >[!NOTE]
   >
   >Mer information om OAuth finns på [den här artikeln](/help/oauth-with-azure-active-directory-for-dynamics-crm.md). Om du har några frågor om processen kontaktar du din [!DNL Marketo Measure]-kontorepresentant.
