---
description: Data Warehouse Access - Reader-konto
...
1. I [!DNL Marketo Measure], överst på sidan, klickar du på **[!UICONTROL My Account]** > **[!UICONTROL Settings]**.
   ...
   ![Marketo Measure navigeringsmeny med alternativen Mitt konto och Inställningar](assets/data-warehouse-access-reader-account-1.png)
...
1. Den här sidan har länken till ditt Snowflake datalager och ditt användarnamn.
   ...
   ![Data Warehouse informationssida med Snowflake URL och användarnamn](assets/data-warehouse-access-reader-account-3.png)
...
1. Klicka på länken som finns i Snowflake URL, så kommer du till inloggningssidan för Snowflake där du anger ditt användarnamn och lösenord. _Om du inte har ditt lösenord läser du stegen nedan för att återställa det_.
   ...
   ![Snowflake inloggningssida med användarnamn och lösenordsfält](assets/data-warehouse-access-reader-account-4.png)

1. När du är inloggad klickar du på **[!UICONTROL Worksheets]** överst på sidan.

   ![Snowflake-gränssnitt med navigeringsalternativ för kalkylblad](assets/data-warehouse-access-reader-account-5.png)
...
1. Databasobjekten BIZIBLE_ROI_V3 finns till vänster på skärmen. Ange lagerställe, databas och schema i listrutan längst upp i frågefönstret. Det ska bara finnas ett alternativ för varje. Nu kan du köra frågor i Snowflake frågeredigerare.
   ...
   ![Snowflake-frågeredigerare med BIZIBLE_ROI_V3-databas och listruteväljare](assets/data-warehouse-access-reader-account-6.png)
...
![Data Warehouse-sida med knappen Återställ lösenord](assets/data-warehouse-access-reader-account-7.png)

![Tillfällig lösenordsvisning efter lösenordsåterställning](assets/data-warehouse-access-reader-account-8.png)
...
* **Namn på lagerställe** (krävs inte alltid)
  ...
  ![Data Warehouse informationssida med information om databas- och lagerställenamn](assets/data-warehouse-access-reader-account-9.png)
