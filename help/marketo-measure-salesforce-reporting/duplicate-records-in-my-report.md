---
description: Duplicera poster i Min rapportvägledning för Marketo Measure-användare
...
![Det här är en rapport om kontakter med Buyer Touchpoints. Återigen innebär detta att](assets/marketo-reports-1.gif)
