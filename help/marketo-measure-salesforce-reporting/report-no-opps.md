---
description: Rapporttyp för kontakter utan säljprojekt - vägledning för Marketo Measure-användare
...
1. Gå till **[!UICONTROL Setup]** > **[!UICONTROL Create]** > **[!UICONTROL Report Types]**.
   ...
   ![1. Gå till Konfigurera Skapa rapporttyper.](assets/new-types-1.png)

1. Välj **[!UICONTROL New Custom Report Type]**.

   ![1. Välj Ny anpassad rapporttyp.](assets/new-types-10.jpg)
...
1. Därifrån kommer du att länka Kontaktobjektet till Buyer Touchpoints-objektet. Se till att du väljer knappen &quot;Varje A-post måste ha minst en relaterad B-post.&quot;
   ...
   ![1. Därifrån kommer du att länka kontaktobjektet till köparen](assets/new-types-12.png)
