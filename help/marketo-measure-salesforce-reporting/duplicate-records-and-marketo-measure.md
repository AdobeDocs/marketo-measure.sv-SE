---
description: Duplicera poster och [!DNL Marketo Measure] vägledning för Marketo Measure-användare
...
![Exempelrapport: Marketo Measure People with Buyer Touchpoints.](assets/additional-functionality-1.png)
