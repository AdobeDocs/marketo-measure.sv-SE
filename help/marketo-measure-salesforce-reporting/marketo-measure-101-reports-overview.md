...
![Alla Marketo Measure-kunder som använder Marketo Measure och Salesforce](assets/bizible-guide-1.png)
...
![Kontaktpunkter för Buyer-attribuering med säljprojekt](assets/bizible-guide-2.png)
...
När du är bekant med _[!DNL Marketo Measure]101.._-rapporterna kanske du vill återskapa dem från anpassade rapporttyper för mer anpassade rapporteringsbehov. Om du skapar de [[!DNL Marketo Measure] anpassade rapporttyperna](/help/marketo-measure-salesforce-reporting/creating-report-types.md) kan du hämta in anpassade fält som du vanligtvis använder i andra CRM-rapporter. Detta hjälper dig att ta [!DNL Marketo Measure]-rapportering till nästa nivå!
