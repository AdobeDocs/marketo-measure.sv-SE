...
Uppdatera ditt minne om hur du överför kostnadsinformation genom att läsa [den här artikeln](/help/marketing-spend/marketing-channel-costs.md).
...
Om du använder några anpassade [!UICONTROL Lead]-, [!UICONTROL Contact]- eller [!UICONTROL Opportunities]-faser kan du också ha anpassat vilken del av pipelinen som de här faserna ska mappas till och om de ska inkluderas i en anpassad attribueringsmodell. En gång i kvartalet kan du besöka [den här artikeln](/help/advanced-features/custom-attribution-models/custom-attribution-model-and-setup.md) för att uppdatera minnet på den anpassade scenmappningen och säkerställa att du spårar dina anpassade stadier korrekt.
...
Mer information om [!DNL Marketo Measure] Machine Learning Model finns i [den här artikeln](/help/advanced-features/custom-attribution-models/machine-learning-model-faq.md).
