---
description: Resurslista för [!DNL Marketo Measure]
title: Resurslista för [!DNL Marketo Measure]
...
* [Vad är marknadsattribuering?](/help/marketing-attribution.md)
* [[!DNL Marketo Measure] attribueringsmodeller](/help/attribution-models.md)
...
* [Synkronisera SFDC Campaigns med Buyer Touchpoints](/help/channel-tracking-and-setup/offline-channels/legacy-processes/campaigns-and-campaign-members.md)
* [Överför marknadsföringsutgifter](/help/marketing-spend/marketing-channel-costs.md#uploading-marketing-costs)
* [Återanslut annonskonton](/help/api-connections/reauthorizing-connected-accounts.md)
* [Lägger till [!DNL Marketo Measure] JavaScript](/help/marketo-measure-tracking/adding-marketo-measure-script.md)
   * [Uteslut Forms](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md)

**Rapportering**

* [Skapar anpassade rapporttyper med  [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/new-report-types/creating-report-types.md) (om du måste rapportera anpassade lead-/kontakt-/säljprojektsfält)
* [Ordlista för  [!DNL Marketo Measure] fält](/help/glossary.md)

**Felsökning**

* [Bevilja  [!DNL Marketo Measure] supportåtkomst till SFDC](/help/miscellaneous/granting-salesforce-access-to-marketo-measure-support.md)
* Kontakta: [[!DNL Marketo] Support](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}
