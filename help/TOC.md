...
+ [!DNL Marketo Measure]-spårning {#marketo-measure-tracking}
   + Konfigurera spårning {#setting-up-tracking}
      ...
      + Lägger till [!DNL Marketo Measure] skript i olika formulärproviders {#adding-marketo-measure-script-to-different-form-providers}
...
+ Konfiguration och installation {#configuration-and-setup}
   + Komma igång med [!DNL Marketo Measure] {#getting-started-with-marketo-measure}
      ...
      + [Förklaring av Touchpoint-positioner och generering över BT:er och  [!DNL BATs]](configuration-and-setup/getting-started-with-marketo-measure/explanation-of-touchpoint-positions-and-generation-across-bts-and-bats.md)
...
+ API-anslutningar {#api-connections}
   + Använder API-anslutningar för [!DNL Marketo Measure] {#utilizing-marketo-measures-api-connections}
...
+ [!DNL Marketo Measure] Identifiera användargränssnitt {#marketo-measure-discover-ui}
   + Kontrollpaneler {#dashboards}
      ...
      + [Kontrollpanel för attributerade affärsmöjligheter](marketo-measure-discover-ui/dashboards/attributed-opportunity-dashboard.md)
      ...
      + [Kontrollpanel för nyckelordens ROI](marketo-measure-discover-ui/dashboards/keyword-roi-dashboard.md)
...
+ [!DNL Marketo Measure] och Marketo {#marketo-measure-and-marketo}
   + [!DNL Marketo Measure] integreringar med Marketo {#marketo-measure-integrations-with-marketo}
      ...
      + [Integrering med Marketo Engage](marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/marketo-engage-people-integration.md)
...
+ [!DNL Marketo Measure] Salesforce Reporting {#marketo-measure-salesforce-reporting}
   ...
   + Ytterligare funktioner {#additional-functionality}
      ...
      + [Salesforce Record Storage-storlekar](marketo-measure-salesforce-reporting/additional-functionality/salesforce-record-storage-sizes.md)
...
+ BI-rapportmallar {#bi-report-templates}
   + [Rapportmall för [!DNL Marketo Measure] - Power BI](bi-report-templates/marketo-measure-report-template-power-bi.md)
...
+ [!DNL Marketo Measure] Ultimate {#marketo-measure-ultimate}
   + [[!DNL Marketo Measure] Ultimate - översikt](marketo-measure-ultimate/marketo-measure-ultimate-overview.md)
   ...
   + [Migrering från Tier 1-2 till [!DNL Marketo Measure] Ultimate](marketo-measure-ultimate/migration-from-tier-to-marketo-measure-ultimate.md)
...
+ Versionsinformation {#release-notes}
   ...
   + Tidigare versioner {#previous-releases}
      + [Versionsinformation: 2023](release-notes/previous-releases/2023.md)
