...
+ [!DNL Marketo Measure] Spårning {#marketo-measure-tracking}
   + Konfigurera spårning {#setting-up-tracking}
      ...
      + Lägger till [!DNL Marketo Measure] Skript till olika formulärleverantörer {#adding-marketo-measure-script-to-different-form-providers}
         ...
         + [AJAX](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/ajax-form-handling.md)
...
+ Konfiguration och installation {#configuration-and-setup}
   + Komma igång med [!DNL Marketo Measure] {#getting-started-with-marketo-measure}
      ...
      + [Attribution Mapping Method](configuration-and-setup/getting-started-with-marketo-measure/attribution-mapping-methodology.md)
...
+ Kanalspårning och inställningar {#channel-tracking-and-setup}
   ...
   + Offlinekanaler {#offline-channels}
      ...
      + [Synkroniserar historiska data](channel-tracking-and-setup/offline-channels/syncing-historical-data.md)
      + [[!UICONTROL Campaigns and Campaign Members]](channel-tracking-and-setup/offline-channels/campaigns-and-campaign-members.md)
      + [Synkroniseringsdatum för kampanj](channel-tracking-and-setup/offline-channels/campaign-sync-dates.md)
      ...
      + [Skapa en kampanjlistvy för [!DNL Salesforce] Kampanjer](channel-tracking-and-setup/offline-channels/creating-a-campaign-list-view-for-salesforce-campaigns.md)
      + [Synkronisera offlinekampanjer](channel-tracking-and-setup/offline-channels/syncing-offline-campaigns.md)
...
+ Avancerat [!DNL Marketo Measure] Funktioner {#advanced-marketo-measure-features}
   + Anpassade attributmodeller {#custom-attribution-models}
      ...
      + [Anpassade modellinställningar: Aktivera spårning av fälthistorik](advanced-marketo-measure-features/custom-attribution-models/custom-model-setup-enable-field-history-tracking.md)
   ...
   + Verksamhetsattribuering {#activities-attribution}
      ...
      + [[!DNL Salesforce] Verksamhetsattribuering](advanced-marketo-measure-features/activities-attribution/salesforce-activities-attribution.md)
      + [Vanliga frågor om aktivitetsattribuering](advanced-marketo-measure-features/activities-attribution/activities-attribution-faq.md)
   + Boomerang {#boomerang}
   ...
   + Kontobaserad marknadsföring {#account-based-marketing}
      + [Kontobaserad attribuering](advanced-marketo-measure-features/account-based-marketing/account-based-attribution.md)
...
+ [!DNL Marketo Measure] Upptäck användargränssnitt {#marketo-measure-discover-ui}
   ...
   + Använda [!DNL Marketo Measure]&#39;s Reporting Platform {#using-marketo-measures-reporting-platform}
      ...
      + [Granska genomskärningar](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/drill-throughs.md)
      + [Filter](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/filters.md)
      + [Vanliga frågor](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/faq.md)
      + [Åtagandesökväg](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/engagement-path.md)
      + [Marknadsföringsgrupper](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/marketing-ops-tiles.md)
      + [Översikt över paneler](marketo-measure-discover-ui/using-marketo-measures-reporting-platform/overview-board-tiles.md)
...
+ [!DNL Marketo Measure] och Dynamics {#marketo-measure-and-dynamics}
   ...
   + Dynamics-rapportering {#dynamics-reporting}
      ...
      + [Dynamics-kampanjer och marknadsföringslistor](marketo-measure-and-dynamics/dynamics-reporting/dynamics-campaigns-and-marketing-lists.md)
+ [!DNL Marketo Measure] och Marketo {#marketo-measure-and-marketo}
   + [!DNL Marketo Measure] Integrering med Marketo {#marketo-measure-integrations-with-marketo}
      ...
      + [Integrering av Marketo Engage](marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/marketo-engage-people-integration.md)
...
+ Säkerhet och efterlevnad {#security-and-compliance}
   + Efterlevnadsrelaterade resurser {#compliance-related-resources}
      ...
      + [Begränsningar för säkerhetssession: IP-adresser att Tillåtslista](security-and-compliance/compliance-related-resources/security-session-restrictions-ip-addresses-to-allowlist.md)
