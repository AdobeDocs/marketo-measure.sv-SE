...
>[!TIP]
>
>Lär dig hur du kontrollerar att skriptet är [GDPR-kompatibelt](/help/security-and-compliance/compliance-related-resources/ensuring-consent-for-gdpr-in-marketo-measure-js.md){target="_blank"}.
...
Mer information finns [här](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-via-google-tag-manager.md){target="_blank"}.
...
* Lösning: Du måste tvinga ett av formulären att rapportera användaren till [!DNL Marketo Measure] baserat på cachelagrade data och diskutera övergivningsmetoder. Vanligtvis kan [rapportera användarkod](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/ajax-form-handling.md){target="_blank"} lösa detta.
...
* Lösning: Dessa [rapportanvändarmallar](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/ajax-form-handling.md){target="_blank"} kan användas av ditt webbdev-team för att lägga till den kod som behövs.
