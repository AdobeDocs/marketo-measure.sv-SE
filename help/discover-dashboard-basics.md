---
description: Introducerar gränssnittet Discover på kontrollpanelen, filter, detaljåtgärder, korsfiltrering, export och fokusläge
...
![Aktivera nedåtpilen genom att klicka på den nedåtriktade pilen som är markerad med en grå](assets/discover-basics-8.png)

Om du vill gå ned ett fält i taget aktiverar du detaljnivåikonen och väljer ett visuellt element, t.ex. ett fält.

![Om du vill gå igenom ett fält i taget aktiverar du detaljnivån](assets/discover-basics-2.gif)

Använd dubbelpilens detaljikon för att gå till nästa hierarkinivå.

![Använd detaljikonen med dubbelpil för att gå vidare till nästa hierarki](assets/discover-basics-1.gif)

Använd den gaffelliknande ikonen om du vill lägga till ytterligare en hierarkinivå i den aktuella vyn.

![Använd den gaffelliknande ikonen för att lägga till ytterligare en hierarkinivå i din](assets/discover-basics-12.gif)
...
![Om du vill exportera underliggande data från en visuell bild håller du pekaren över dess övre högra hörn](assets/discover-basics-6.gif)
...
![Om du väljer ett värde eller en axeletikett i en visualisering kommer andra att korsfiltreras](assets/discover-basics-3.gif)
