...
![Arkitektur som visar dataflöde och anslutningar för Marketo Measure Tiers 1-3](assets/marketo-measure-ultimate-overview-1.png)

**[!DNL Marketo Measure Ultimate]**

![Arkitektur som visar Marketo Measure Ultimate med AEP-integrering](assets/marketo-measure-ultimate-overview-2.png)
...
![Dataflödesdiagram som visar B2B-dataimport via AEP-plattformen](assets/marketo-measure-ultimate-overview-3.png)
...
![Gränssnitt för standardvalutainställningar med alternativet USD-valuta](assets/marketo-measure-ultimate-overview-4.png)
...
![Konfiguration av sandlådemappning som visar datauppsättningar och dataflödesrelationer](assets/marketo-measure-ultimate-overview-5.png)
...
![Gränssnitt för scenmappning med inbyggda och anpassade scenkonfigurationer](assets/marketo-measure-ultimate-overview-6.png)

Kontaktpunktsregler för kampanjmedlemmar och Touchpoint-regler för aktivitet är datauppsättningsspecifika.

![Konfigurering av kontaktpunktsregler för kampanjmedlem efter datauppsättning](assets/marketo-measure-ultimate-overview-7.png)

![Konfiguration av aktivitetsslutpunktsregler efter datauppsättning](assets/marketo-measure-ultimate-overview-8.png)
