---
description: Guider för att konfigurera Marketo Measure-åtkomst via Adobe Admin Console-profiler och logga in
...
![När du ansluter till Adobe Admin Console visas din Marketo Measure](assets/adobe-setup-1.png)
...
![Om du klickar på Marketo Measure produktkort visas alla dina](assets/adobe-setup-2.png)
...
![När en användare har lagts till i en produktprofil kan han/hon](assets/adobe-setup-3.png)
