---
description: Rekommenderad [!DNL Salesforce] Behörighet för [!DNL Marketo Measure] Ansluten användarvägledning för Marketo Measure-användare
