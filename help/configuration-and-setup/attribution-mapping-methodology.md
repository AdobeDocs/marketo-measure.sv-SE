---
description: Attribution Mapping Methodology Guide för Marketo Measure-användare
...
![Från och med nu tillhandahåller Marketo Measure mappning av konto-ID. Detta](assets/adobe-setup-1.png)
...
![De flesta klienter använder mappning av konto-ID, men Marketo Measure kan se ut](assets/adobe-setup-2.png)
...
![Förutom att bara titta på kontaktrollerna för affärsmöjligheten, Marketo](assets/adobe-setup-3.png)
