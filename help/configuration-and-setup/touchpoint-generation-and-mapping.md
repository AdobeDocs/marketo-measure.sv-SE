---
description: Riktlinjer för generering och mappning av kontaktpunkter för Marketo Measure-användare
...
>[!MORELIKETHIS]
>
>* [Mappar onlinekontaktytor till [!DNL Marketo Measure] Kanaler/underkanaler](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
>* [Synkroniserar CRM-kampanjer inifrån SFDC](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
>* [Synkroniserar CRM-kampanjer inifrån [!DNL Marketo Measure]](/help/channel-tracking-and-setup/custom-campaign-sync.md)
>* [Mappar CRM-kampanjer till [!DNL Marketo Measure] Kanaler/underkanaler](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
>* [Skapar kontaktytor från försäljningsaktiviteter](/help/channel-tracking-and-setup/salesforce-activities-attribution.md)
>* [Aktiviteter, frågor och svar och mappningsaktiviteter, kontaktytor till kanaler/underkanaler](/help/channel-tracking-and-setup/activities-attribution-faq.md)
