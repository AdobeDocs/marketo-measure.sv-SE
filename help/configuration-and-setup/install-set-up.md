---
description: Installation och konfiguration av Salesforce-paket - [!DNL Marketo Measure]
title: '[!DNL Salesforce] Paketinstallation och konfiguration'
...
# Installation av Salesforce-paket{#marketo-measure-salesforce-package-installation}
...
1. Välj **[!UICONTROL Install]för alla användare**.
   ...
   ![1. Välj Installera för alla användare.](assets/bizible-full-1.png)

1. När installationen är klar kan du visa den.

   ![1. När installationen är klar kan du visa den.](assets/bizible-taxonomy-1.png)

När du har slutfört installationen kan du uppdatera dina [[!DNL Salesforce] sidlayouter](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"} med [!DNL Marketo Measure]-fälten om du vill.

>[!NOTE]
>
>Läs om de [!DNL Marketo Measure] behörighetsuppsättningar som har skapats och [hur de används](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}.
