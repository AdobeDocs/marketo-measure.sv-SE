...
[!DNL Salesforce] kunder klickar [här](/help/configuration-and-setup/install-set-up.md).

[!DNL Microsoft Dynamics] kunder klickar [här](/help/microsoft-dynamics-crm-installation-guide.md).
