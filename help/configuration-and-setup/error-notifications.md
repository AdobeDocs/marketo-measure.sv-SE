---
description: Felmeddelandeguide för Marketo Measure-användare
...
![Klicka på Visa](assets/adobe-setup-1.png) om du vill visa det fullständiga meddelandemeddelandet i Marketo Measure.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Se följande dokumentation för CRM för att få hjälp med att justera API-kreditallokeringar:</p>
          ...
          <p>
          &lt;img alt="felmeddelanden 3" src="assets/error-notifications-3.png"
          </p>
      </td>
    </tr>
    <tr>
...
Salesforce-dokumentation om flödesutlösare <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">finns här</a>.
    ...
    <tr>
      ...
      <td>Granska utlösarkod som gör att infogningen/uppdateringen misslyckas. Mer information om utlösare finns i följande Salesforce-dokumentation:
        ...
        <p>
        Ange alla nödvändiga behörigheter för <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Marketo Measure-användaren</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Läs följande <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Experience League-artikel</a> om du vill ha mer information om vilka behörigheter Marketo Measure behöver.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Vi kräver läs- och skrivbehörighet för alla fält som har prefixet "bizible2__". En fullständig lista över dessa fält finns <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">i den här artikeln</a>.</td>
    </tr>
    <tr>
      ...
      <td>Se följande Experience League-dokument om du behöver hjälp med att aktivera den här behörigheten i din CRM<br/>
          <a href="/help/marketo-measure-salesforce-reporting/enabling-the-permission-to-edit-converted-leads.md">Aktivera behörighet att redigera konverterade leads</a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Detta tillstånd krävs för Salesforce-objekt för att vi ska kunna synkronisera din Marketo Measure och Salesforce.</td>
    ...
    <tr>
      ...
      <td>Det finns flera orsaker till det här felet som är specifika för Salesforce-organisationen. Nedan beskrivs några vanliga felsökningssteg som kan lösa problemet:
        <ul>
          <li>Granska alla behörigheter som krävs för varje <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">objekt och fält</a>.</li>
    ...
    <tr>
      ...
      <td>Inaktivera inställningen för begränsad lista i Salesforce Org.
          <p>
    ...
    <tr>
      ...
      <td>Uppgradera ditt paket till den senaste versionen:
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">God praxis</a>
          </li>
