---
description: Skillnad mellan Buyer Touchpoints och Buyer Attribution Touchpoints Guide för Marketo Measure-användare
...
![Här är en skärmbild av en BT i Salesforce:](assets/adobe-setup-1.png)

**Hur ser en Buyer Attribution Touchpoint ut i Salesforce?**

Här är en skärmbild av en BAT i [!DNL Salesforce]:

![Här är en skärmbild av en BAT i Salesforce:](assets/adobe-setup-2.png)
