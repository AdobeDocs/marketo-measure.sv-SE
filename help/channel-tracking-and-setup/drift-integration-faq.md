---
description: Driftintegration - vanliga frågor och svar för Marketo Measure-användare
...
Här är några av de vanligaste frågorna som ingår i [!DNL Marketo Measure]-integreringen med Drift. Om det finns frågor som inte beskrivs nedan kontaktar du Adobe Account Team (din kontohanterare) eller [Marketo Support](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}.
...
![Om det finns aktivitetsregler för att skapa kontaktytor för Drift](assets/chat-integration-1.png)
