---
description: Best Practices for Touchpoint Settings guidelines for Marketo Measure users
...
>[!MORELIKETHIS]
>
>* [Översikt över borttagning och undertryckning av pekpunkter](/help/channel-tracking-and-setup/touchpoint-removal-and-touchpoint-suppression.md)
>* [Varför ska du aldrig ta bort kontaktpunkter](/help/channel-tracking-and-setup/why-you-should-never-delete-touchpoints.md)?
>* [Kontaktpunkter för köpare (BT) respektive Buyer Attribution Touchpoints (BAT)](/help/configuration-and-setup/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
