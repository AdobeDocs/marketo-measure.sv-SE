---
description: Dynamics Campaigns and Marketing Lists guidelines for Marketo Measure users
...
![När leads eller kontakter läggs till direkt i en kampanj anges de](assets/dynamics-lists-1.png)
...
![Det finns några](assets/dynamics-lists-10.png) om du vill inkludera de här posterna i kontaktytans resa
...
![Marketo Measure stöder inte anpassade svarsvärden.](assets/dynamics-lists-2.png)

Det här är lagersvarsvärdena för Campaign-svaret:

![Det här är börssvarsvärdena för kampanjsvaret:](assets/dynamics-lists-3.png)
...
![Om du vill aktivera en marknadsföringslista för kontaktytor finns det en separat inställning](assets/legacy-processes-10.png)
...
![Slutpunktsdatumet för en marknadsföringslista är vanligtvis den ListMember som skapades](assets/dynamics-lists-6.png)
...
![För varje kampanjtyp kan den mappas till en kanal och](assets/dynamics-lists-7.png)

![För varje kampanjtyp kan den mappas till en kanal och](assets/dynamics-lists-8.png)
