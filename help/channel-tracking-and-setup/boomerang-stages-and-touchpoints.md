---
description: Boomerang Stages och Touchpoints Guide for Marketo Measure users
...
>[!NOTE]
>
>[Instruktioner om hur du konfigurerar Boomerang-stadier](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![Utan Boomerang-stadier (föregående) visas bara den senaste MQL](assets/boomerang-stages-18.png)
...
![I exemplet nedan har det här Marketo Measure-kontot inkluderat MQL](assets/boomerang-stages-19.png)
