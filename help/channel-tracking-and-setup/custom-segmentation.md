---
description: Anpassad segmenteringsvägledning för Marketo Measure-användare
...
![Använd den här teckenförklaringen för att förstå de olika ikoner som finns på sidan](assets/custom-segmentation-1.png)
