---
description: Synkronisera historik för datainstruktion för Marketo Measure-användare
...
![Om du vill synkronisera historiska onlinedata måste data vara ordnade i Salesforce](assets/dynamics-lists-1.png)
...
![Om data finns på annat håll (till exempel fortfarande i Marketing](assets/dynamics-lists-10.png))
...
Mer information om synkronisering av marknadsföringslistor finns här: [[!DNL Dynamics] Kampanjer och marknadsföringslistor](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
