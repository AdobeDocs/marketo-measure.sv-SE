---
description: Best Practices for Stage Mapping guidelines for Marketo Measure users
...
* Observera att avsnittet Lead- eller Kontaktstadium är uppdelat i Förlorat, Öppna och Konverterad. Kontrollera att stadierna är i rätt scenavsnitt
   ...
   * Om du använder Marketo Measure Ultimate och har angett ditt standardinstrumentpanelsobjekt som kontakt ska du inte använda de två fält nedan som är specifika för lead ([läs mer](/help/data-integrity-requirement.md){target="_blank"}).
      * b2b.personStatus
      * b2b.isConverted
...
>[!MORELIKETHIS]
>
>[Skillnaden mellan Funnel-scener och anpassade modellsteg](/help/channel-tracking-and-setup/custom-attribution-model-and-setup.md)
