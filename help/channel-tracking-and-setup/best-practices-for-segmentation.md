---
description: Best Practices for Segmentation guidelines for Marketo Measure users
...
* Bygg segmenteringen för både lead/kontakt och säljprojekt så att du kan använda den i hela funnel
   * Om du använder Marketo Measure Ultimate och har angett ditt standardinstrumentpanelsobjekt som kontakt ska du inte använda de två fält nedan som är specifika för lead ([läs mer här](/help/data-integrity-requirement.md){target="_blank"}).
      * b2b.personStatus
      * b2b.isConverted
   * Alla segment kommer inte att justeras i hela funnel
      * En segmentkategori med typen säljprojekt hör inte till Leads, till exempel, men ett segment som är relaterat till Region är troligen en kategori som kan definieras i hela funnel
...
>[!MORELIKETHIS]
>
>[Konfigurera anpassad segmentering](/help/channel-tracking-and-setup/custom-segmentation.md)
