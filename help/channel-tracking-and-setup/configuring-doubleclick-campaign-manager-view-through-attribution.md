---
description: Configuring Doubleclick Campaign Manager View Through Attribution guidelines for Marketo Measure users
...
>[!NOTE]
>
>Om du använder integreringen [!DNL Marketo Measure] och [!DNL DoubleClick Campaign Manager] behöver vi en [API-anslutning](/help/api-connections/integrated-ad-platforms.md) så att vi kan hämta information om kampanjer och kreatörer för att kunna matcha annonserna.
...
Mer information om funktionen [!DNL Marketo Measure] Visa via attribut finns i [Marketo Measure View Through Attribution FAQ](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md).
...
1. Bekräfta att avgränsarna mappas enligt följande när den har lagts till. Detta bör vara automatiskt när taggen används:
   ...
   ![n = %n slumpmässigt nummermakro](assets/view-attribution-1.png)
