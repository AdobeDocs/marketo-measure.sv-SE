---
description: Best Practices for Custom Model guidelines for Marketo Measure users
...
>[!MORELIKETHIS]
>
>* [Anpassad attributmodell och inställning](/help/channel-tracking-and-setup/custom-attribution-model-and-setup.md)
>* [Aktivera spårning av fälthistorik för anpassad modell](/help/channel-tracking-and-setup/custom-model-setup-enable-field-history-tracking.md)
>* [Maskinininlärningsmodell](/help/channel-tracking-and-setup/machine-learning-model-faq.md)
