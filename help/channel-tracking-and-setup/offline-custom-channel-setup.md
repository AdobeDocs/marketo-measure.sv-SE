---
description: Riktlinjer för anpassade kanalinställningar offline för Marketo Measure-användare
...
![Kalkylbladet har tre kolumner:](assets/offline-channels-1.png)
...
![Nedan finns ett exempel på logik som inte skulle användas i Marketo Measure](assets/offline-channels-12.png)
...
![I scenariot ovan vill du skapa en unik kampanj](assets/offline-channels-13.png)
...
Läs mer om [synkronisering av offlinekampanjer [!DNL Salesforce] med [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
>
>* [[!DNL Marketo Measure] Självstudiekurser: Synkronisera offlinekampanjer](https://experienceleague.adobe.com/en/docs/marketo-measure-learn/tutorials/onboarding/marketo-measure-salesforce/syncing-offline-campaigns){target="_blank"}
>
>* [Integrering av Marketo Engage-program](/help/marketo-engage-programs-integration.md){target="_blank"}
