---
description: Anpassad modellinställning - Aktivera riktlinjer för spårning av fälthistorik för Marketo Measure-användare
...
1. Gå till objektet där det anpassade fältet finns och klicka på knappen **[!UICONTROL Set History Tracking]**.
   ...
   ![1. Gå till objektet där det anpassade fältet finns och klicka på](assets/custom-models-1.png)

1. Markera de fält som du vill spåra ändringar i.

   ![1. Markera de fält som du vill spåra ändringar i.](assets/custom-models-10.png)
