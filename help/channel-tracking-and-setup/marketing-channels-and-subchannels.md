---
description: Marknadsföringskanaler och delkanaler - vägledning för Marketo Measure-användare
...
Om du vill anpassa vilken&quot;bucket&quot; som dina leads hamnar i baserat på deras UTM-parametrar kan du använda Kanalregler. [Klicka här](/help/channel-tracking-and-setup/online-custom-channel-setup.md) om du vill ha mer information om hur du konfigurerar och underhåller kanalreglerna.

Lär dig hur du konfigurerar dina [onlinekanaler](/help/channel-tracking-and-setup/online-custom-channel-setup.md) och [offlinekanaler](/help/channel-tracking-and-setup/offline-custom-channel-setup.md), samt skillnaden mellan dem.
