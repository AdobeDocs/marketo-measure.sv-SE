---
description: Studie-scenariovägledning för Boomerang för Marketo Measure-användare
...
![Lead 1 konverteras sedan till en kontakt med ett säljprojekt,](assets/boomerang-stages-18.png)
...
![I det här scenariot har en kund bara valt att spåra SQL](assets/boomerang-stages-19.png)
...
![I det här scenariot har en kund valt att spåra MQL och](assets/boomerang-stages-21.png)
...
![I det här scenariot har en kund valt att spåra MQL, SQL,](assets/boomerang-stages-23.png)
...
![I det här scenariot har en kund valt att spåra MQL, SQL,](assets/boomerang-stages-25.png)
...
![I det här scenariot har en kund valt att spåra demonstrationen och](assets/boomerang-stages-25.png)
