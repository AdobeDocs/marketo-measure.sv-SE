...
1. Klicka på den egenskap som du skapade.
   ...
   ![1. Klicka på den egenskap du skapade.](assets/marketo-launch-12.png)

1. Klicka på **[!UICONTROL Extensions]**.

   ![1. Klicka på Tillägg.](assets/marketo-launch-11.png)

1. Klicka på fliken **[!UICONTROL Catalog]** och sök efter [!UICONTROL Bizible].

   ![1. Klicka på fliken Katalog och sök efter Bizible.](assets/marketo-launch-10.png)

1. Klicka på [!UICONTROL Bizible Analytics] i rutan **[!UICONTROL Install]**.

   ![1. Klicka på Installera i panelen Bizible Analytics.](assets/marketo-launch-7.png)
...
1. Klicka på **[!UICONTROL Save]**.
   ...
   ![1. Klicka på Spara.](assets/marketo-launch-8.png)

1. Klicka på **[!UICONTROL Rules]** och välj sedan **[!UICONTROL Create New Rule]**.

   ![1. Klicka på Regler och välj sedan Skapa ny regel.](assets/marketo-launch-9.png)

1. Klicka på knappen **[!UICONTROL Add]** under [!UICONTROL Events].

   ![1. Klicka på knappen Lägg till under Händelser.](assets/marketo-launch-2.png)
...
1. Klicka på knappen **[!UICONTROL Add]** under Åtgärder.
   ...
   ![1. Klicka på knappen Lägg till under Åtgärder.](assets/marketo-launch-3.png)
...
1. Klicka på **[!UICONTROL Save]**.
   ...
   ![1. Klicka på Spara.](assets/marketo-launch-5.png)
