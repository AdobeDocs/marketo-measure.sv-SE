---
description: Använd kontrollpanelen Leadhastighet för att mäta tiden i varje steg i funnel och jämföra hastigheten per kanal över tiden
...
Snabbkontrollpanelen ger en dynamisk bild av hur de potentiella kunderna rör sig genom funnel och ger marknadsförare och säljteam viktiga insikter i konverteringstiderna över olika kanaler. Det här verktyget är värdefullt för att svara på viktiga frågor om hur lång tid det tar att konvertera leads och hur effektivt säljprocessen går genom försäljningsfaser, vilket gör att ni kan optimera era engagemangsstrategier för snabbare tillväxt och konverteringar.
...
![I vilken månad fick leads/kontakter den snabbaste säljutvecklingen](assets/lead-dashboard-2.png)
...
* I vilken kanal visas den snabbaste ledutvecklingen i funnel-stadierna?
* Hur varierar ledhastigheten i MQL-scenen mellan olika kanaler?

![Hur varierar lead-hastigheten i MQL-scenen mellan olika](assets/lead-dashboard-3.png)
