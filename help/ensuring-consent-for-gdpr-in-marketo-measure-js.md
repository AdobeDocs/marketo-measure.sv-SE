---
description: Visar hur bizible.js ska konfigureras att vänta på användarens godkännande av GDPR innan cookies eller data skickas.
...
>[!NOTE]
>
>I det här fallet kopplar [!DNL bizible.js] en on-click-händelse till HTML-elementet med ID &quot;ConsentButtonId&quot;.

När du klickar på det här HTML-elementet skapar [!DNL bizible.js] en cookie som kommer ihåg att användarens samtycke har tagits emot och börjar samla in analysdata som vanligt.
