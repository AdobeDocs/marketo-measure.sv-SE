---
description: Aktuell versionsinformation för Marketo Measure-användare
...
![Du kan nu skapa segment med hjälp av fälten Kampanj och Kampanjmedlem](assets/release-notes-2.png)
...
* [Boomerang-scener och kontaktpunkter](/help/channel-tracking-and-setup/boomerang-stages-and-touchpoints.md){target="_blank"}
* [Konfigurerar bokmärken](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md){target="_blank"}
* [Scenarier i Boomerang](/help/channel-tracking-and-setup/boomerang-stage-scenarios.md){target="_blank"}
...
[Vi har skapat dokumentation](/help/configuration-and-setup/error-notifications.md){target="_blank"} med tydliga felbeskrivningar och omfattande felsökningssteg som hjälper dig att anpassa dig till den här ändringen.
