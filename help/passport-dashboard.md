---
description: Beskriver Passport-kontrollpanelen som spårar hur huvudkontakter och möjligheter rör sig genom faser över tid
...
![Både start- och slutdatum är inkluderande.](assets/passport-dashboard-1.png)
...
![Både start- och slutdatum är inkluderande.](assets/passport-dashboard-2.png)
