---
description: Åtkomstkontroll för [!UICONTROL Discover Data Download] - Marketo Measure - produktdokumentation
title: Åtkomstkontroll för [!UICONTROL Discover Data Download]
...
1. Klicka på listrutan och välj lämpligt alternativ för konsolen.
   ...
   <table>
    <tr>
     ...
     <td>Alla användare kan hämta data, både i PDF- och CSV-format.</td>
    </tr>
    <tr>
     <td><strong>Endast administrationsanvändare</strong></td>
     <td>Det är bara administratörsanvändare som kan hämta data, inklusive både PDF- och CSV-format.</td>
    </tr>
    <tr>
