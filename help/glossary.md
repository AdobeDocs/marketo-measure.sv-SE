...
[Klicka här](/help/configuration-and-setup/marketo-measure-object-and-field-taxonomy.md) om du vill se vilket objekt varje Marketo Measure-fält relaterar till.
...
I det här fältet visas den allmänna gruppen av marknadsföringsaktiviteter eller marknadsföringskanal som kontaktytan tillhör (t.ex. Betald sökning, Direkt, Socialt osv.). Kontaktpunkterna grupperas efter hur kanalerna har konfigurerats i Marketo Measure App. [Klicka här](/help/channel-tracking-and-setup/online-custom-channel-setup.md) om du vill ha mer information om marknadsföringskanaler eller om hur du konfigurerar dina kanaler.
...
![Det här fältet visar marknadsföringskanalen och underkanalen som en](assets/overview-resources-16.png)
