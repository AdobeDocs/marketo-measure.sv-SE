...
Referera till [den här artikeln](/help/channel-tracking-and-setup/online-custom-channel-setup.md) för onlinekonfiguration, [den här artikeln](/help/channel-tracking-and-setup/offline-custom-channel-setup.md) för offlinekonfiguration och den här listan över bästa praxis från våra kunder:
...
Mer information om [!DNL Marketo Measure] Machine Learning Model finns i [den här artikeln](/help/channel-tracking-and-setup/machine-learning-model-faq.md).
