...
![Avslutade avtal (CW)](assets/overview-resources-8.png)
...
![Fortsätter från föregående exempel, efter Kate första besök på www.adobe.com via](assets/overview-resources-10.png)
...
![Kate första besök på www.adobe.com via ett lösenord och får 50 %](assets/overview-resources-11.png)
...
![Hillary får ett e-postmeddelande med en länk till prissidan och](assets/overview-resources-12.png)
...
![Efter att affärsmöjligheten har skapats bestämmer Kate, Austin och Hillary sig för att skicka Marketo](assets/overview-resources-13.png)
