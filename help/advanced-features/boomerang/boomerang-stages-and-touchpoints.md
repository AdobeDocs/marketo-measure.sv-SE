...
>[!NOTE]
>[Instruktioner om hur du konfigurerar Boomerang-stadier](/help/advanced-features/boomerang/setting-up-boomerang-stages.md).
...
![Affärsmöjlighetspost som endast visar senaste scenens kontaktytor utan boomerang](assets/1.png)
...
![Boomerang-kontaktytor listade för flera MQL- och SQL-scenövergångar](assets/2.png)
