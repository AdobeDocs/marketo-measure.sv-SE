...
![Leadkundsdiagram som visar MQL- och SQL boomerang-kontaktytor med kronologisk progression till säljprojekt](assets/1-1.png)
...
![Leadresan visar SQL boomerang-kontaktytor med MQL och SAL spårade som anpassade stadier](assets/2-1.png)
...
![Leadresan visar det hoppade SAL-stadiet med SAL- och OC-positioner kombinerade i samma kontaktyta](assets/3.png)
...
![Tre leadkundsdiagram som visar MQL- och SAL boomerang-kontaktytor som översätts till säljprojekt](assets/4.png)
...
![Tre ledande resor med kontaktpunkter för MQL, SQL och SAL boomerang med positionsnumrering på säljprojekt](assets/5.png)
...
![Tre ledande resor med webbbesök, boomerang-kontaktytor som utesluts från säljprojekt när de inträffar efter SQL-steget](assets/6.png)
...
![Tre leadresor med boomerang-attribueringsvikt med flerstegsövergångar](assets/7.png)
...
![Kontaktresa som visar Demo- och Negotiation boomerang-kontaktytor som visas efter OC-kontaktyta i säljprojekt](assets/8.png)
