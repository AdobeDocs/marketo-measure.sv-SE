...
![Bygg undertryckningsregel som visar grupperad AND/OR-logik](assets/2.png)
...
![Klonalternativ för att duplicera undertryckningsregelgrupper](assets/3.png)

Om du gör ett misstag, oroa dig inte. Du kan också ta bort enskilda rader i programsatsen eller hela grupper.

![Ta bort ikoner för enskilda programsatser och regelgrupper](assets/4.png)
...
![Konfiguration för inaktiveringsregler för slutpunkter för Buyer-attribut](assets/5.png)
