...
![Segmentförklaring med ikoner som används i administratören](assets/1.png)
...
![Lägger till en segmentkategori och ett namn i Marketo Measure](assets/2.png)

* Klicka på plusikonen för att visa regelinmatningsfälten. Alternativen i listrutan Fält hämtar fält direkt från CRM

![Regelindatafält för att definiera ett segmentfilter](assets/3.png)
