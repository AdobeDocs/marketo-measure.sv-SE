...
![Inställningssidan för Touchpoint-fält med alternativet Aktivera beräkningsfält](assets/one.png)
...
![Konfiguration av beräknat fält för extrahering av fält i Campaign Source](assets/two.png)
...
![Fältkonfigurationen Rabattkod extraherar kampanjparametern från URL](assets/three.png)
...
![Fältet Adobe Campaign ID extraherar den 6-siffriga cid-parametern](assets/four.png)
...
![Flera beräknade fält extraherar lands- och kampanj-ID-parametrar](assets/five.png)
...
![Initiativfältsmappningskampanjer till kampanjkategorier](assets/six.png)
...
![Regionnamnsmappningstabell med numeriska koder för regionnamn](assets/seven.png)
...
![Sammanfoga konfigurationskombination som kombinerar fälten Segment och Grade](assets/eight.png)
...
![Gränssnitt för att skapa segment som visar tillgängliga kontaktpunktsfält](assets/nine.png)
...
![Dynamisk segmentkonfiguration med fältreferens för klammerparenteser](assets/ten.png)

Regeln refererar till samma Touchpoint-fält och söker efter värden som inte är lika med null.

![Segmentregel med ett villkor som inte är lika med null](assets/eleven.png)
...
![Regex-valideringsverktyget visar ett giltigt uttryck i grönt](assets/twelve.png)

![Regex-valideringsverktyget visar ett ogiltigt uttryck i rött](assets/thirteen.png)
