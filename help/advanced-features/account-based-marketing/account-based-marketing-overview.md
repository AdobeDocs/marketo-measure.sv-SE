...
Mer information om hur du konfigurerar ABM i [!DNL Salesforce]-instansen finns i [Konfigurera ABM-sidlayout i Salesforce](/help/advanced-features/account-based-marketing/account-based-marketing-overview.md#setting-up-abm-page-layout-in-salesforce){target="_blank"}.
...
1. Gå till [!UICONTROL Fields] och flytta fältet Predictive Engagement Score till ditt kontoinformationsavsnitt.
   ...
   ![Kontosidans layout visar fältet Predictive Engagement Score (poäng för prediktiv interaktion)](assets/1.png)

1. Till sist går du till [!UICONTROL Related Lists] och flyttar den relaterade listan Leads till din sidlayout.

   ![Lägger till en Leads-relaterad lista till kontosidans layout](assets/2.png)
...
1. Klicka på **[!UICONTROL Fields]** och lägg till fältet [!UICONTROL Account] där du ser plats på sidan.
   ...
   ![Sidlayout för lead med kontofältet tillagt](assets/3.png)
