...
>[!MORELIKETHIS]
>[Skillnaden mellan Funnel-scener och anpassade modellsteg](/help/advanced-features/custom-attribution-models/custom-attribution-model-and-setup.md#the-difference-between-funnel-stages-and-custom-model-stages)
