---
description: Versionsinformation 2023 för Marketo Measure-användare
...
URL-tabellen i [datalagret](/help/data-warehouse-schema.md){target="_blank"} kommer nu att innehålla ett sidtitelsfält, förutom webbdatatabeller.
...
* [Ny handbok för Discover Dashboard](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Grunderna för instrumentpanel](/help/discover-dashboard-basics.md){target="_blank"}
* [Instrumentpanel för intäktsöversikt](/help/revenue-overview-dashboard.md){target="_blank"}
* [Instrumentpanel för attributerade intäkter](/help/attributed-revenue-dashboard.md){target="_blank"}
* [ROI-instrumentpanel](/help/roi-dashboard.md){target="_blank"}
...
![Skapa nya rapporttyper för leads och kontakter med eller utan kontaktpunkter.](assets/release-notes-3.png)
...
![Ta bort fält för lead/kontakt-FT/LC:](assets/release-notes-5.png)

* Lägg till Touchpoint-fält:

![Lägg till Touchpoint-fält:](assets/release-notes-4.png)
...
![Pekpunktsplaceringsfiltret och eventuella filter som använder FT/LC-fälten,](assets/release-notes-2.png)

![Pekpunktsplaceringsfiltret och eventuella filter som använder FT/LC-fälten,](assets/release-notes-1.png)
...
* Den inaktuella metoden för OAuth med en RefreshToken kommer att bli inaktuell. Läs [den här handboken](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} om du vill uppdatera dina autentiseringsuppgifter för att följa Microsoft bästa praxis för användning av ClientSecret.
...
[Den här artikeln](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} innehåller guider om hur du återskapar rapporter och instrumentpaneler från äldre rapportpaket.
