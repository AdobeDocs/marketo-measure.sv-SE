...
title: Rapportmall för [!DNL Marketo Measure] - Power BI
...
# Rapportmall för [!DNL Marketo Measure] - Power BI {#marketo-measure-report-template-power-bi}

## Komma igång {#getting-started}

Du kommer åt Power BI rapportmall [här](https://github.com/adobe/Marketo-Measure-BI-Templates){target="_blank"}.

Öppna Power BI-filen för Adobe [!DNL Marketo Measure]-rapportmallen.

![Power BI anslutningsdialogruta för Marketo Measure-mall](assets/marketo-measure-report-template-power-bi-1.png)

Du kan hitta specifik information om server, lager och schema i användargränssnittet för [!DNL Marketo Measure] på informationssidan för [!DNL Data Warehouse]. Instruktioner för hur du hittar den här sidan finns [här](/help/data-warehouse/data-warehouse-access-reader-account.md){target="_blank"}.
...
De parametrar som anges när filen öppnas används för att strukturera interna frågor som importerar tabeller från datalagret. Du måste fortfarande konfigurera en dataanslutning till din [!DNL Snowflake]-instans. För detta behöver du samma server- och lagerställenamn tillsammans med ditt användarnamn och lösenord. Information om var du kan hitta ditt användarnamn och återställa lösenordet finns [här](/help/data-warehouse/data-warehouse-access-reader-account.md){target="_blank"}.
...
![Dialogrutan för internt frågegodkännande i Power BI](assets/marketo-measure-report-template-power-bi-2.png)
...
![Frågeredigeraren med datumfilterparametrar](assets/marketo-measure-report-template-power-bi-3.png)
...
![Power Query Editor som visar tillämpade omformningssteg](assets/marketo-measure-report-template-power-bi-4.png)
...
![Dialogrutan för kolumnval visar konfigurationen för borttagna kolumner](assets/marketo-measure-report-template-power-bi-5.png)
...
![Omdöpt kolumnsteg med kolumnnamnsmappningar](assets/marketo-measure-report-template-power-bi-6.png)
...
![Touchpoint-tabell med skiftlägeskänslig ID-omvandling](assets/marketo-measure-report-template-power-bi-8.png)

![Kampanjtabell med kolumn för kopplat ID för skiftlägeskänslig matchning](assets/marketo-measure-report-template-power-bi-9.png)
...
![Affärsmöjlighetstabell med kolumn för företagskonverteringsgrad](assets/marketo-measure-report-template-power-bi-10.png)

Registret Konverteringsfrekvens som lagras i [!DNL Snowflake] innehåller ett datumintervall för varje konvertering. Power BI tillåter inte kopplingsvillkor i en beräkning (det vill säga mellan ett datumintervall). För att kunna ansluta till ett datum har vi lagt till steg i tabellen Konverteringsfrekvens för att expandera raderna så att det finns en rad för varje datum i konverteringsdatumintervallet.

![Konverteringsvärdetabell med expanderade datumrader](assets/marketo-measure-report-template-power-bi-11.png)

## Datamodell {#data-model}

Klicka på bilden nedan för att se vilken version den har.

[![Power BI datamodellsdiagram som visar tabellrelationer](assets/marketo-measure-report-template-power-bi-12.png)](/help/bi-report-templates/assets/power-bi-data-model.png){target="_blank"}
...
Eftersom Power BI bara tillåter relationer mellan tabeller i en kolumn, lades en datumdimensionstabell till för att underlätta kopplingen mellan tabellerna som innehåller belopp (möjlighet och kostnad) och konverteringsgrad. I avsnittet Valutakonvertering finns mer information om hur valutakonverteringar beräknas i den här modellen.
...
![Valutakonverteringsformel som visar DAX-beräkningslogik](assets/marketo-measure-report-template-power-bi-13.png)
...
![Tabellegenskaper som visar definitionsbeskrivningar](assets/marketo-measure-report-template-power-bi-14.png)

![Anpassade kolumndefinitioner i datamodell](assets/marketo-measure-report-template-power-bi-15.png)

![Mät definitioner med DAX-formler](assets/marketo-measure-report-template-power-bi-16.png)

Om du vill visa definitioner för kolumner som kommer direkt från [!DNL Snowflake] läser du [dokumentationen för datalagret](/help/data-warehouse/data-warehouse-schema.md){target="_blank"}
