...
![Ursprungligt SQL-kommandofält för schemaspecifikation](assets/marketo-measure-report-template-tableau-3.png)
...
![Snabbmeny med alternativet Redigera anpassad SQL-fråga](assets/marketo-measure-report-template-tableau-4.png)

![Dialogrutan Anpassad SQL-frågeredigerare i TabletU](assets/marketo-measure-report-template-tableau-5.png)
...
![Affärsmöjlighetstabell med konverteringstariffkolumner](assets/marketo-measure-report-template-tableau-6.png)
...
![Kombinerad tabell som visar typkolumn för entidentifiering](assets/marketo-measure-report-template-tableau-7.png)
...
![Mappningstabell för segmentnamn som visar kategori och egna namn](assets/marketo-measure-report-template-tableau-8.png)
...
![Anpassad SQL med segmentkategorier som bytt namn](assets/marketo-measure-report-template-tableau-9.png)

Det andra alternativet är att byta namn på kolumnerna direkt i tabellen [!DNL Tableau].

![Tabell med segmentkolumner som byter namn](assets/marketo-measure-report-template-tableau-10.png)

## Datamodell {#data-model}

Klicka på bilden nedan för att se vilken version den har.

[![Diagram över tabelldatamodell som visar tabellrelationer](assets/marketo-measure-report-template-tableau-11.png)](/help/bi-report-templates/assets/tableau-data-model.png){target="_blank"}
...
![Kombinerad kanal- och kampanjdimensionstabell](assets/marketo-measure-report-template-tableau-12.png)
...
![Beräkningsfält för valutakonvertering i tabell](assets/marketo-measure-report-template-tableau-13.png)
...
![Verktygstips som visar valutakonverteringsmått](assets/marketo-measure-report-template-tableau-14.png)
...
![Fältdefinitioner i tabellmodell som visar beskrivningar](assets/marketo-measure-report-template-tableau-15.png)
