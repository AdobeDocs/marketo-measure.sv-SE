...
# Migrering från Tier 1-2 till [!DNL Marketo Measure] Ultimate {#migration-from-tier-to-marketo-measure-ultimate}
...
Återimplementera alla källdataanslutningar i AEP, inklusive CRM- och Marketo Engage-anslutningar.
...
* I Ultimate härleds övergångar för tidigare CRM-scener i stället för att läsas direkt, eftersom det inte finns någon direkt CRM-anslutning.
...
* Alla Discover-instrumentpaneler är desamma som i Tiered-lösningen, med tillägg av Attribution AI-instrumentpaneler.
