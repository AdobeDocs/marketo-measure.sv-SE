...
I det här scenariot har en kund valt att **MQL** och **SQL** som spåras med Boomerangs. Varje position för Boomerang-kontaktyta märks med scenen och numret som den inträffar i (MQL-01, SQL-01, MQL-02). etc). Den sista boomerang-kontaktytan för den scenen kommer också att ha&quot;(Sista)&quot; i kontaktytspositionen.
...
I det här scenariot kommer Lead aldrig att gå över till SAL-stadiet. Den konverteras till en kontakt innan den når SAL-stadiet, i stort sett&quot;hoppar över&quot; SAL-stadiet. I denna situation [!DNL Marketo Measure] förutsätts att SAL sker med OC-kontaktytan, och både SAL- och OC-positionen visas på samma kontaktyta.
...
Lead 1 ändras till SAL och konverteras sedan till en kontakt med ett säljprojekt. I det här fallet kombineras positionen SAL-01 (sista) och OC i samma kontaktyta.
