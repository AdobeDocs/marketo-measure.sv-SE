...
![Sidan Autentiseringsinställningar med alternativet Anpassad SSO-inloggning](assets/single-sign-on-1.png)
...
![SAML-konfigurationsformulär med mappningsfält för användarattribut](assets/single-sign-on-2.png)
...
![Konfiguration av mappning av användarroll med alternativen Standardanvändare och Administratör](assets/single-sign-on-3.png)
...
![Knappen Testa SAML-autentisering och valideringsstatusmeddelandet](assets/single-sign-on-4.png)
...
![Spara-knapp för autentiseringsinställningar och bekräftelsemeddelande](assets/single-sign-on-5.png)
...
![Bekräftelseskärmen för enkel inloggning](assets/single-sign-on-6.png) har slutförts
...
![Inställningsmenyn för Salesforce med roller under Hantera användare](assets/6.png)
...
![Menynavigering i Dynamics-inställningar till säkerhetsroller](assets/7.png)

![Listan Dynamics-säkerhetsroller visar tillgängliga rollalternativ](assets/8.png)
...
![Sidan Användare som visar externa Google-inloggningsanvändare](assets/9.png)
