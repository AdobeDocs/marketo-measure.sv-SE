---
description: Begränsningar för säkerhetssession - IP-adresser som ska Tillåtslista
...
![Salesforce nätverksåtkomstsida för att lägga till betrodda IP-intervall](assets/1.png)
