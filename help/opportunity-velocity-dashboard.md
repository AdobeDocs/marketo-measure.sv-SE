---
description: Beskriver kontrollpanelen för säljprojektssnabbhet för att spåra tiden i varje försäljningsfas och jämföra trender efter kanal över tid
...
![Under vilken månad upplevde affärsmöjligheterna den snabbaste utvecklingen genom försäljningen](assets/lead-dashboard-2.png)
...
![Hur varierar hastigheten på affärsmöjligheten i fasen Prospect mellan olika](assets/lead-dashboard-3.png)
