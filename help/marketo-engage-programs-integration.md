...
1. En modal visas där du kan ange program-ID från Marketo.
   ...
   ![Reglerna körs på en samplingsstorlek på 5 000 medlemmar. Om din](assets/marketo-engage-programs-05.png)

   Du kan klicka på Antal medlemmar för att visa en lista över Marketo People ID:n som är berättigade inom programmet.

   ![Du kan klicka på Antal medlemmar för att visa en lista över Marketo](assets/marketo-engage-activities-08.png)
