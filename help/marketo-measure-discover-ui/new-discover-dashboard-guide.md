  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>Sammanfattning av nyckelord och avkastning på investering i Creative:</strong>Inaktuell (se nedan)</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <strong>Kohort-Funnel:</strong>Kohort Journey-instrumentpanel</li>
          <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>Sammanfattning av nyckelord och avkastning på investering i Creative</strong>
        </p>
      </td>
      <td>
...
Nya funktioner finns i artikeln [Identifiera grundläggande funktioner för kontrollpanelen](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}.
