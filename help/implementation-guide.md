---
description: '[!DNL Marketo Measure] Ultimate-implementeringshandbok - [!DNL Marketo Measure]'
...
Läs mer om [Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}.
...
[Datauppsättningsöversikt](https://experienceleague.adobe.com/sv/docs/experience-platform/catalog/datasets/overview#){target="_blank"}: Alla data som har importerats till AEP lagras i Data Lake som datauppsättningar. En datauppsättning är en lagrings- och hanteringskonstruktion för en datamängd, vanligtvis en tabell, som innehåller ett schema (kolumner) och fält (rader).
...
![Välj Lägg till mallar för dataanvändning från en källa](assets/marketo-guide-2.png)

* Välj ett konto och alla B2B-mallar för att skapa tio standardscheman för B2B.

![Välj ett konto och alla B2B-mallar för att skapa tio standard-B2B](assets/marketo-guide-3.png)
...
1. Mappa fälten från Source till schemat.
   ...
   >[!NOTE]
   >
   >[Marketo Measure Ultimate dataintegritetskrav](/help/data-integrity-requirement.md){target="_blank"}
...
![Användare kan mappa faser från olika källor.](assets/marketo-guide-5.png)

Om faserna inte mappas kommer systemet inte att fungera eftersom det inte kommer att finnas någon plats för data.

Om du använder Marketo Measure Ultimate och har angett ditt standardinstrumentpanelsobjekt som kontakt ska du inte använda de två fält nedan som är specifika för lead ([läs mer här](/help/data-integrity-requirement.md){target="_blank"}).
