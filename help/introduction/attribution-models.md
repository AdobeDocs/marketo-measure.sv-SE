---
description: Marketo Measure attribueringsmodeller
...
![Tidslinje för kundresa med fyra milstolpar: First Touch, Lead Creation, Opportunity Creation och Closed-Won](assets/1-1.png)
...
![Första beröringsmodelldiagram som visar 100 % attribueringskrediter till Adwords-kanal](assets/2.png)
...
![Modelldiagram för att skapa leads som visar 100 % attribueringskrediter till LinkedIn-kanal](assets/3.png)
...
![U-formad modelldiagram med 50 % kredit till Adwords och 50 % till LinkedIn](assets/4.png)
...
![W-Shaped-modelldiagram som visar 30 % kreativitet för FT-, LC- och OC-kontaktytor med 10 % mellanliggande kontaktytor](assets/5.png)
...
![Modelldiagram över fullständig sökväg som visar 22,5 % uppskattning av alla kontaktytor mot FT, LC, OC och CW med 10 % till mellanliggande kontaktytor](assets/6.png)
