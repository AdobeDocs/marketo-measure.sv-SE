---
description: Täcker kontrollpanelen för attributerade säljprojekt som visar affärsmöjlighetsbelopp och antal per kanalunderkanal och kampanj över tid
...
![Vad var fördelningen av tilldelat affärsmöjlighetsbelopp per kanal förra månaden?](assets/attributed-dashboard-3.png)
...
![Klicka på en gren om du vill ta bort mer från det efterföljande hierarkilagret.](assets/attributed-dashboard-2.png)
