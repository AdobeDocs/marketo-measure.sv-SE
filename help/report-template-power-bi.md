...
![Öppna Power BI-filen för Adobe Marketo Measure Reporting-mallen.](assets/marketo-bi-1.png)

Du kan hitta specifik information om server, lager och schema i användargränssnittet för [!DNL Marketo Measure] på informationssidan för [!DNL Data Warehouse]. Instruktioner för hur du hittar den här sidan finns [här](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
De parametrar som anges när filen öppnas används för att strukturera interna frågor som importerar tabeller från datalagret. Du måste fortfarande konfigurera en dataanslutning till din [!DNL Snowflake]-instans. För detta behöver du samma server- och lagerställenamn tillsammans med ditt användarnamn och lösenord. Information om var du kan hitta ditt användarnamn och återställa lösenordet finns [här](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
![För att begränsa vilka data som importeras till modellen ställs varje tabell in](assets/marketo-bi-2.png)
...
![Eftersom datumfiltren tillämpas på ändringsdatumet för en](assets/marketo-bi-3.png)
...
![Några omformningar har tillämpats på data i Power Query.](assets/marketo-bi-6.png)
...
![De flesta tabeller i Marketo Measure datalager innehåller denormaliserad dimensionell](assets/marketo-bi-7.png)
...
![/Klistra in funktioner och filtrering.](assets/marketo-bi-8.png)

![/Klistra in funktioner och filtrering.](assets/marketo-bi-11.png)
...
![Vi har](assets/marketo-bi-10.png) om du vill lägga till funktioner för valutakonvertering i beräkningarna i modellen.
...
![Registret Konverteringsfrekvens som lagras i Snowflake innehåller ett datumintervall](assets/marketo-bi-9.png)

## Datamodell {#data-model}

Klicka på bilden nedan för att se vilken version den har.

[![Klicka på bilden nedan för att se vilken version den har.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![Valutakonverteringsmåtten i den här modellen ersätter värdet 1.0](assets/marketo-bi-13.png)
...
![Definitioner har lagts till i Power BI-modellen för tabeller, anpassade](assets/marketo-bi-15.png)

![Definitioner har lagts till i Power BI-modellen för tabeller, anpassade](assets/marketo-bi-16.png)

![Definitioner har lagts till i Power BI-modellen för tabeller, anpassade](assets/marketo-bi-14.png)
